...
draft: false
summary: "Continuing from the previous article, we learned how to set up the environment for reading code and where to start reading the code. In this part, we'll introduce methods for..."
description: "Continuing from the previous article, we learned how to set up the environment for reading code and where to start reading the code. In this part, we'll introduce methods for..."
...
![parser.y8](20200712191711.webp)

It's an option.

![parser.y9](20200712191843.webp)
...
![conf4](20200715164756.webp)

In the code, it is represented as:

![conf5](20200715164930.webp)
